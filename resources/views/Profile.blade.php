                            ...
                            <div class="mb-3">
                                <div class="row">
                                    ...
                                    <select class="form-control" id="divisi" name="divisi">
                                        ...
                                        <option value="Finance" {{ old('divisi', $profile->divisi ?? '') == 'Finance' ? 'selected' : '' }}>Finance</option>
                                        <option value="Legal" {{ old('divisi', $profile->divisi ?? '') == 'Legal' ? 'selected' : '' }}>Legal</option>
                                        <option value="General Affair" {{ old('divisi', $profile->divisi ?? '') == 'General Affair' ? 'selected' : '' }}>General Affair</option>
                                        <option value="Management" {{ old('divisi', $profile->divisi ?? '') == 'Management' ? 'selected' : '' }}>Management</option>
                                        <option value="Staff" {{ old('divisi', $profile->divisi ?? '') == 'Staff' ? 'selected' : '' }}>Staff</option>
                                        <option value="IT Support" {{ old('divisi', $profile->divisi ?? '') == 'IT Support' ? 'selected' : '' }}>IT Support</option>
                                        <option value="Front Office" {{ old('divisi', $profile->divisi ?? '') == 'Front Office' ? 'selected' : '' }}>Front Office</option>
